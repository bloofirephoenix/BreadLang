...
{
	public Dictionary<string, IMacro> Macros = new();
	...
	public void Macro(Parser parser)
	{
		...
		if (Macros.ContainsKey(name))
			ErrorHandler.Instance!.Error(parser.Current(), "A macro with that name already exists");
		...
		var macro = new UserMacro(this, arguments);
